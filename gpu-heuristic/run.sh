...
declare -a maxcosts=(154	54	136	88	46	56	168	198	440	268	300	450	120	80	120	108	96 )
...
declare -a maxtimes=(36	52	54	38	44	54	46	16	42	82	22	68	10	6	10	16	14)
...
# declare -a maxcosts=(56)
# declare -a maxtimes=(54)
# declare -a wkf=("gpu")
trap CTRLC SIGINT
